...
$$\sum_{i \in S, j \in S'} x_{ij} \geq y_k \quad \forall k \in S',\quad S' \neq \emptyset,\quad S'=L-S,\quad S \subset L \quad\text{with}\quad 1 \in S$$
$$\sum_{i \in S, j \in S'} x_{ji} \geq y_k \quad \forall k \in S',\quad S' \neq \emptyset,\quad S'=L-S,\quad S \subset L \quad\text{with}\quad 1 \in S$$
